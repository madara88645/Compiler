...
class StrategyHandler:
    ...
    CLASSIFICATION_KEYWORDS = [
        "classify", "categorize", "label", "sort", "identify", "detect",
        "recognize", "tag", "group", "cluster", "determine type", "which type",
    ]
    
    # Keywords indicating transformation tasks
    TRANSFORMATION_KEYWORDS = [
        "convert", "transform", "translate", "rewrite", "rephrase",
        "format", "restructure", "summarize", "expand", "simplify",
    ]
    ...
    def _inject_cot(self, complexity: float, text: str) -> Optional[str]:
        ...
        cot_indicators = [
            ...
            "reasoning", "break down", "walk through",
        ]
