...
DOMAIN_RULES: Dict[str, Dict] = {
    ...
    "coding": {
        "keywords": [
            ...
            "script", "program", "algorithm", "implement", "develop",
            "debug", "refactor", "optimize", "compile", "runtime",
            "variable", "loop", "conditional", "exception", "error",
            "test", "unit test", "integration", "deploy", "git",
        ],
        "languages": {
            "python": {
                "indicators": ["python", "py", "django", "flask", "fastapi", "pandas", "numpy", "pip", "pytest", "def ", "import "],
                "suggestions": [
                    DomainSuggestion("Use type hints for function signatures", "best_practice", 65, "PEP 484 compliance"),
                    ...
                    DomainSuggestion("Consider using dataclasses or Pydantic models", "architecture", 45),
                ],
            },
            "javascript": {
                "indicators": ["javascript", "js", "node", "npm", "react", "vue", "angular", "typescript", "ts", "const ", "let ", "=>"],
                "suggestions": [
            ...
            "rust": {
                "indicators": ["rust", "cargo", "crate", "fn ", "let mut", "impl ", "trait ", "struct "],
                "suggestions": [
                    DomainSuggestion("Handle Result and Option types properly", "error_handling", 70),
            ...
            "go": {
                "indicators": ["golang", "go ", "go mod", "func ", "package ", "goroutine", "channel"],
                "suggestions": [
                    DomainSuggestion("Handle errors explicitly (no exceptions)", "error_handling", 70),
    ...
    "creative_writing": {
        "keywords": [
            "story", "novel", "chapter", "character", "plot", "scene",
            "dialogue", "narrative", "fiction", "poem", "poetry",
            "screenplay", "script", "prose", "creative", "write",
            "protagonist", "antagonist", "setting", "theme", "climax",
        ],
        "structures": {
            "heros_journey": {
                "indicators": ["hero", "journey", "adventure", "quest", "transformation", "mentor"],
                "stages": ["ordinary world", "call to adventure", "refusal", "mentor", "threshold", 
                          "tests", "approach", "ordeal", "reward", "return"],
            },
            "three_act": {
                "indicators": ["act", "beginning", "middle", "end", "setup", "confrontation", "resolution"],
        ...
        "style_checks": {
            ...
            "filter_words": {
                "words": ["felt", "saw", "heard", "noticed", "realized", "thought", "knew", "seemed"],
                "suggestion": DomainSuggestion(
    ...
    "business": {
        "keywords": [
            "business", "strategy", "kpi", "metric", "roi", "revenue",
            "profit", "growth", "market", "customer", "stakeholder",
            "executive", "presentation", "report", "analysis", "data",
            "budget", "forecast", "quarterly", "annual", "dashboard",
            "okr", "goal", "objective", "target", "benchmark",
        ],
        "formats": {
            "bluf": {
    ...
    "education": {
        "keywords": [
            ...
            "student", "beginner", "intermediate", "advanced", "concept",
            "example", "exercise", "practice", "understand", "comprehend",
        ],
        "levels": {
            "beginner": {
                "indicators": ["beginner", "basic", "intro", "introduction", "start", "new to"],
                "suggestions": [
                    DomainSuggestion("Use simple analogies and real-world examples", "pedagogy", 70),
    ...
    "data_science": {
        "keywords": [
            ...
            "dataset", "feature", "training", "prediction", "regression",
            "classification", "clustering", "neural", "deep learning",
            "statistics", "visualization", "pandas", "numpy", "sklearn",
        ],
        "checks": {
            "data_quality": {
...
class DomainHandler(BaseHandler):
    ...
    def handle(self, ir_v2: IRv2, ir_v1: IR) -> None:
        ...
        for suggestion in analysis.suggestions:
            ir_v2.constraints.append(ConstraintV2(
        ...
        for check_name, check_rules in rules["universal_checks"].items():
            ...
            if check_name == "security":
                ...
                for pattern in risk_patterns:
                    if re.search(pattern, text_lower):
                        analysis.suggestions.append(check_rules["suggestion"])
                        analysis.diagnostics.append(DiagnosticItem(
                            severity="warning",
    ...
    def _analyze_creative_writing(self, text: str, text_lower: str) -> DomainAnalysis:
        ...
        if detected_structure:
            ...
            if any(word in text_lower for word in ["plot", "story", "chapter", "character"]):
                analysis.suggestions.append(DomainSuggestion(
