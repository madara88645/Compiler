...
## 2026-05-18 - Focus states for interactive lists
...
**Learning:** When a user executes a localized, inline action (like clicking "Copy to Clipboard" on a context output), they expect immediate confirmation. Without it, they might click multiple times or check the resulting state manually, breaking their flow.
