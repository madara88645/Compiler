        ...
        <div className="relative inline-block ml-2 group">
            ...
            {showTooltip && (
                <div
                    id="info-tooltip"
                    role="tooltip"
                    className="absolute z-50 w-64 p-3 mt-2 text-xs font-normal text-left text-neutral-300 bg-neutral-900 border border-neutral-700 rounded-md shadow-xl -left-2 top-full break-words"
                >
