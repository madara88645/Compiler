        ...
        <div className="h-full flex flex-col p-6 max-w-6xl mx-auto gap-6 animate-fade-in">
            <header className="flex items-center justify-between border-b border-white/5 pb-4">
                ...
                <div className="flex items-center gap-4 bg-zinc-900/50 p-2 rounded-xl border border-white/5">
                    ...
                    >
                        {loading ? "Compressing..." : <>⚡ Compress <kbd className="hidden md:inline-block ml-2 text-[10px] font-mono opacity-50 border border-white/20 rounded px-1.5 py-0.5 bg-white/5">⌘ Enter</kbd></>}
                    </button>
                </div>
            </header>
