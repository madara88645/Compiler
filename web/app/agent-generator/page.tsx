...
export default function AgentGenerator() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const data = await apiJson<{ system_prompt: string }>(
                "/agent-generator/generate",
                {
                    method: "POST",
                    headers: buildGeneratorApiHeaders({
            ...
            showError(e);
            setError(
                e instanceof Error ? e.message : "Failed to generate agent",
            );
        } finally {
            setLoading(false);
                ...
                <div className="flex-1 min-h-0 flex flex-col md:flex-row overflow-hidden">
                    ...
                    <div className="w-full md:w-[35%] min-h-0 p-5 flex flex-col gap-5 border-r border-white/5 bg-black/10 overflow-hidden">
                        <div className="flex flex-col gap-2">
                            ...
                            >
                                Describe the &quot;Vibe&quot;, Task, or Role of
                                the agent you want to build. Be as specific or
                                vague as you like.
                            </p>
                        </div>
                        ...
                        <div className="flex items-center gap-3 bg-white/5 p-3 rounded-xl border border-white/5">
                            ...
                            >
                                <div
                                    className={`w-4 h-4 bg-white rounded-full shadow-sm transform transition-transform ${multiAgent ? "translate-x-4" : "translate-x-0"}`}
                                />
                            </button>
                            <div className="flex flex-col">
                                ...
                                <span className="text-[10px] text-zinc-500">
                                    Decompose into 2-4 specialized agents
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 bg-white/5 p-3 rounded-xl border border-white/5">
                            ...
                            >
                                <div
                                    className={`w-4 h-4 bg-white rounded-full shadow-sm transform transition-transform ${includeExampleCode ? "translate-x-4" : "translate-x-0"}`}
                                />
                            </button>
                            <div className="flex flex-col">
                                <span className="text-xs font-medium text-zinc-200">
                                ...
                                <span className="text-[10px] text-zinc-500">
                                    Yes = include example code, No = keep it
                                    code-free to avoid confusion
                                </span>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            title={
                                !description.trim()
                                    ? "Enter a description first to generate"
                                    : "Generate Agent"
                            }
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center text-zinc-600 gap-6 p-10 text-center opacity-60">
                                ...
                                <div className="max-w-xs space-y-2">
                                    ...
                                    <p className="text-sm text-zinc-500">
                                        Enter a description to generate a
                                    ...
                                    <button
                                        ...
                                        className="mt-6 px-4 py-2 bg-green-600/20 text-green-300 border border-green-500/30 rounded-xl hover:bg-green-600/30 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 flex items-center gap-2 mx-auto"
                                    >
                                        Start Architecting
                                    </button>
                                </div>
