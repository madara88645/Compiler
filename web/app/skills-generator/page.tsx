...
export default function SkillsGenerator() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const data = await apiJson<{ skill_definition: string }>(
            ...
            showError(e);
            setError(
                e instanceof Error ? e.message : "Failed to generate skill",
            );
        } finally {
            setLoading(false);
                    ...
                    <div className="w-full md:w-[35%] min-h-0 p-5 flex flex-col gap-5 border-r border-white/5 bg-black/10 overflow-hidden">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-xs text-zinc-500">
                                Describe the skill&apos;s purpose, inputs, and
                                expected behavior.
                            </p>
                        </div>
                        ...
                        <div className="flex items-center gap-3 bg-white/5 p-3 rounded-xl border border-white/5">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-[10px] text-zinc-500">
                                    Yes = include implementation code, No = keep
                                    it code-free
                                </span>
                            </div>
                        </div>
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center text-zinc-600 gap-6 p-10 text-center opacity-60">
                                ...
                                <div className="max-w-xs space-y-2">
                                    ...
                                    <p className="text-sm text-zinc-500">
                                        Define a capability to generate a
                                        robust, modular skill definition for
                                        your AI agents.
                                    </p>
                                    <button
                                        type="button"
                                        ...
                                        className="mt-6 px-4 py-2 bg-yellow-600/20 text-yellow-300 border border-yellow-500/30 rounded-xl hover:bg-yellow-600/30 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500 flex items-center gap-2 mx-auto"
                                    >
                                        Start Forging
                                    </button>
                                </div>
