...
export default function Home() {
  ...
  const [activeTab, setActiveTab] = useState<"system" | "user" | "plan" | "expanded">("system");
  ...
  const handleGenerate = useCallback(async (textOverride?: string) => {
    ...
    setLoading(true);
    setStatus(liveMode ? "Live Compiling..." : "Generating...");
  ...
  return (
    <main className="flex min-h-screen flex-col bg-zinc-900 text-zinc-100">
      ...
      <div className="flex-1 flex flex-col md:flex-row h-full overflow-hidden">
        ...
        {/* Right Panel: Output */}
        <div className="w-full md:w-2/3 flex flex-col bg-zinc-950">
          {result ? (
            <>
              {/* Tabs */}
