...
describe("Offline compiler page", () => {
  beforeEach(() => {
    ...
    apiFetchMock.mockRejectedValue(new Error("Offline backend unavailable"));
    compilePromptMock.mockRejectedValue(new Error("Offline backend unavailable"));
  });
  ...
  it("keeps failed offline compiles visible and retryable", async () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: "Retry offline compile" }));
