...
def test_public_routes_obey_global_enforcement_flag(method, path, payload, monkeypatch):
...
def test_public_routes_reject_invalid_keys_when_global_enforcement_enabled(
    monkeypatch,
):
    monkeypatch.setenv("PROMPTC_REQUIRE_API_KEY_FOR_ALL", "true")
