...
def test_compare_vague_vs_specific():
    ...
    specific = "Write a beginner-friendly tutorial explaining Python list comprehensions with 3 examples."
...
def test_compare_missing_persona():
    ...
    with_persona = "You are a physics professor. Explain quantum computing concepts to undergraduate students."
...
def test_compare_category_breakdown():
    ...
    prompt_b = "You are an AI expert. Create a comprehensive guide explaining neural network architecture."
