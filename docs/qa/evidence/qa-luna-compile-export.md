...
- `user-prompt.md` — contained the exact generated Goals/Tasks text.
- `compile-result.json` — parsed as valid JSON and contained the compile keys (`system_prompt`, `user_prompt`, `plan`, `ir`, `ir_v2`, `critique`, and `readiness_markdown`).
